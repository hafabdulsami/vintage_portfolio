  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        scrolled
          ? "bg-[#2a2520]/90 backdrop-blur-lg py-3 md:py-4 border-b border-primary/20"
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 flex justify-between items-center">
        ...
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="hidden md:block px-6 py-2 bg-primary text-[#2a2520] font-semibold rounded-full hover:shadow-lg hover:shadow-primary/50 transition-all border-2 border-primary font-display"
        >
          Hire Me
        </motion.button>
      </div>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden absolute top-full left-0 w-full bg-[#2a2520]/95 backdrop-blur-lg border-b border-primary/20"
          >
            <div className="flex flex-col items-center py-6 gap-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-2 bg-primary text-[#2a2520] font-semibold rounded-full border-2 border-primary font-display"
              >
                Hire Me
              </motion.button>
            </div>
